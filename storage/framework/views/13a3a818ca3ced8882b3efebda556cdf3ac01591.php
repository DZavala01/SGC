<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <?php if(Auth::check()): ?>
            ...
            <form action="<?php echo e(route('manualesguias.update', $manuales_guias->id)); ?>" method="post" enctype="multipart/form-data" class="col-12">
                        ...
                        <div class="row g-3 align-items-center">
                            <div class="row g-3 align-items-center">
                                <div class="col-md-9">
                                    ...
                                    <input type="text" class="form-control" id="titulo" name="titulo" value="<?php echo e($manuales_guias->titulo); ?>">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input type="text" class="form-control" id="descripcion" name="descripcion" value="<?php echo e($manuales_guias->descripcion); ?>">
                                </div>

                                <div class="col-md-3">
                                    <label class="font-weight-bold" for="donde_aplica">¿Dónde aplica?</label>
                                    <input type="text" class="form-control"
                                        id="donde_aplica" name="donde_aplica" value="<?php echo e($manuales_guias->donde_aplica); ?>">
                                </div>

                                <div class="col-md-6">
                                    <label class="font-weight-bold" for="link">Link para mayor información</label>
                                    <input type="text" class="form-control" id="link" name="link" value="<?php echo e($manuales_guias->link); ?>">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="autor" name="autor"  value="<?php echo e($manuales_guias->autor); ?>">
                                </div>
                                    <p>
                                      Sube archivos:
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SGC\resources\views/manuales_guias/edit.blade.php ENDPATH**/ ?>