<?php $__env->startSection('content'); ?>
    ...
    <div class="container">
        <?php if(Auth::check()): ?>
            ...
            <form action="<?php echo e(route('problemasolucions.store')); ?>" method="post" enctype="multipart/form-data"
                class="col-12">
                <div class="row">
                    <div class="col">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SGC\resources\views/problemas_soluciones/create.blade.php ENDPATH**/ ?>